...
The check itself is twenty rules written in ordinary Python. No model gets a
...
- The rules engine: twenty detection rules in Python with weights, quoted spans
