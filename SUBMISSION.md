...
The check itself is thirty-five rules written in ordinary Python. No model gets a
...
- The rules engine: thirty-five detection rules in Python with weights, quoted spans
