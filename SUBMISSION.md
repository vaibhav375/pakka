...
The check itself is thirty-four rules written in ordinary Python. No model gets a
...
- The rules engine: thirty-four detection rules in Python with weights, quoted spans
