...
The check itself is thirty-three rules written in ordinary Python. No model gets a
...
- The rules engine: thirty-three detection rules in Python with weights, quoted spans
